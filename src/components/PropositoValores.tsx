...
export default function PropositoValores() {
  return (
    <section style={{ background: 'var(--hueso)', padding: '5rem 2rem' }}>
      {/* La maquetación vive en globals.css, no aquí. Un `gridTemplateColumns`
          en línea le gana a cualquier media query, y entonces la columna no se
          apila nunca en móvil — que es exactamente lo que pasó. */}
