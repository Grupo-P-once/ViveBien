...
/* ── Testimonios ─────────────────────────────────────────────────────────── */
const TESTIMONIOS = [
  { initials: 'RC', nombre: 'Ricardo Castillo', rol: 'Empresario Textil', color: 'linear-gradient(45deg,var(--rojo),var(--rojo-claro))', texto: '"Excelente servicio para rentar mi nave industrial. El equipo fue muy profesional y directo. Encontramos el cliente ideal en menos de un mes."' },
  { initials: 'MG', nombre: 'Mariana G.', rol: 'Propietaria Residencial', color: 'linear-gradient(45deg,var(--azul),#2A3B5E)', texto: '"La transparencia fue clave. En todo momento estuvieron disponibles para mis dudas sobre mi primer terreno campestre."' },
...
/* ── Beneficios ──────────────────────────────────────────────────────────── */
const BENEFICIOS = [
  { icon: 'fa-shield-halved', color: 'var(--rojo)', bg: 'rgba(139,26,26,.08)', title: 'Seguridad y Transparencia', desc: 'Procesos claros con revisión legal y contratos rigurosos para proteger tu patrimonio al máximo.' },
  { icon: 'fa-user-tie', color: 'var(--azul)', bg: 'rgba(27,54,93,.08)', title: 'Atención Personalizada', desc: 'Sin intermediarios innecesarios. Te acompañamos desde la primera búsqueda hasta la firma.' },
  { icon: 'fa-chart-line', color: 'var(--exito)', bg: 'rgba(39,149,70,.08)', title: 'Asegura tu Plusvalía', desc: 'Conocemos el mercado a la perfección y te orientamos sobre las zonas con mayor retorno de inversión.' },
]
  ...
  return (
    <>
      ...
      <section ref={heroRef} style={{
        ...
        <div style={{
            ...
            >
              ...
              <form onSubmit={buscar} style={{
                ...
                <select value={form.tipo} onChange={e => setForm(f => ({ ...f, tipo: e.target.value }))}
                  ...
                  <option value="" style={{ background: 'var(--azul-profundo)' }}>Tipo de propiedad</option>
                  <option value="casa" style={{ background: 'var(--azul-profundo)' }}>Casa Residencial</option>
                  <option value="nave" style={{ background: 'var(--azul-profundo)' }}>Nave / Bodega</option>
                  <option value="terreno" style={{ background: 'var(--azul-profundo)' }}>Terreno</option>
                  <option value="comercial" style={{ background: 'var(--azul-profundo)' }}>Local Comercial</option>
                </select>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }} className="hero-stats">
            ...
            >
              <i className="fab fa-whatsapp" style={{ fontSize: '1.75rem', color: 'var(--whatsapp)', flexShrink: 0 }} />
              <div style={{ flex: 1 }}>
            ...
            <div key={rep} style={{ display: 'flex', alignItems: 'center', gap: '0', whiteSpace: 'nowrap' }}>
              {[
                ...
                <span key={item.text} style={{
                  ...
                  <i className={`fa ${item.icon}`} style={{ color: 'var(--rojo-claro)', fontSize: '.8rem' }} />
                  {item.text}
        ...
        <div style={{
          ...
          <FadeLeft>
            <h2 style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 900, fontSize: '2.2rem', marginBottom: '.5rem', lineHeight: 1.15 }}>
              <GradientText colors={['var(--rojo)', 'var(--rojo-claro)', 'var(--rojo)']} animationSpeed={5}>
                ¿Qué es Vive Bien?
              </GradientText>
            </h2>
            <p style={{ color: 'var(--azul-claro)', fontWeight: 600, fontSize: '1rem', marginBottom: '1.5rem', letterSpacing: '.5px' }}>
      ...
      <section style={{ background: 'var(--hueso)', padding: '6rem 2rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 900, fontSize: 'clamp(1.6rem,3.5vw,2.4rem)', color: 'var(--azul)', marginTop: '.5rem' }}>
              Permítenos guiarte.
            </h2>
          </div>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 900, fontSize: 'clamp(1.6rem,3.5vw,2.4rem)', color: 'var(--azul)' }}>
              Nuestra <span style={{ fontWeight: 700, color: 'var(--rojo)' }}>Esencia</span>
            </h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: '2rem' }}>
            <AnimatedContent direction="vertical" distance={50} delay={0}>
              <div style={{ background: 'rgba(139,26,26,.04)', borderLeft: '5px solid var(--rojo)', borderRadius: '20px', padding: '2.5rem', transition: 'all .35s', height: '100%' }}
                ...
                <div style={{ width: '50px', height: '50px', background: 'var(--rojo)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '1.3rem', marginBottom: '1.2rem' }}>
                  <i className="fa fa-bullseye" />
                </div>
                <h3 style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 800, fontSize: '1.3rem', color: 'var(--rojo)', marginBottom: '.8rem' }}>Misión</h3>
            ...
            <AnimatedContent direction="vertical" distance={50} delay={0.1}>
              <div style={{ background: 'rgba(27,54,93,.04)', borderLeft: '5px solid var(--azul)', borderRadius: '20px', padding: '2.5rem', transition: 'all .35s', height: '100%' }}
                ...
                onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '' }}>
                <div style={{ width: '50px', height: '50px', background: 'var(--azul)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '1.3rem', marginBottom: '1.2rem' }}>
                  <i className="fa fa-eye" />
                </div>
                <h3 style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 800, fontSize: '1.3rem', color: 'var(--azul)', marginBottom: '.8rem' }}>Visión</h3>
                <p style={{ fontSize: '.92rem', lineHeight: 1.75, color: '#555' }}>
            ...
            <AnimatedContent direction="vertical" distance={50} delay={0.2}>
              <div style={{ background: 'rgba(39,149,70,.04)', borderLeft: '5px solid var(--exito)', borderRadius: '20px', padding: '2.5rem', transition: 'all .35s', height: '100%' }}
                ...
                onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '' }}>
                <div style={{ width: '50px', height: '50px', background: 'var(--exito)', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontSize: '1.3rem', marginBottom: '1.2rem' }}>
                  <i className="fa fa-gem" />
                </div>
                <h3 style={{ fontFamily: 'var(--font-montserrat)', fontWeight: 800, fontSize: '1.3rem', color: 'var(--exito)', marginBottom: '.8rem' }}>Valores</h3>
                <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '.85rem' }}>
                  {['Honestidad ante todo', 'Empatía con cada cliente', 'Compromiso con los resultados', 'Profesionalismo continuo', 'Innovación con sentido humano'].map(v => (
                    <li key={v} style={{ display: 'flex', alignItems: 'center', gap: '.8rem', fontSize: '.9rem', color: '#555', fontWeight: 600 }}>
                      <span style={{ width: '30px', height: '30px', background: 'rgba(39,149,70,.1)', color: 'var(--exito)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '.8rem', flexShrink: 0 }}>
      ...
      <style>{`
        ...
        select option { background: var(--azul-profundo); color: #fff; }
...
const INPUT: React.CSSProperties = {
  ...
  color: 'var(--texto)', background: '#fff', boxSizing: 'border-box',
...
function ContactForm() {
  ...
  if (estado === 'ok') return (
    <div style={{ textAlign: 'center', padding: '2rem' }}>
      <i className="fa fa-check-circle" style={{ color: 'var(--whatsapp)', fontSize: '3rem', display: 'block', marginBottom: '1rem' }} />
      <h3 style={{ fontFamily: 'var(--font-montserrat)', color: 'var(--azul)' }}>¡Mensaje enviado!</h3>
  ...
  return (
    <form onSubmit={enviar} noValidate>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
        <div>
          <label style={{ fontSize: '.85rem', fontWeight: 600, color: 'var(--azul)', display: 'block', marginBottom: '.3rem' }}>Nombre completo *</label>
          <input required value={data.nombre} onChange={e => setData(d => ({ ...d, nombre: e.target.value }))} placeholder="Juan Pérez" style={INPUT} />
        </div>
        <div>
          <label style={{ fontSize: '.85rem', fontWeight: 600, color: 'var(--azul)', display: 'block', marginBottom: '.3rem' }}>Teléfono *</label>
      ...
      <div style={{ marginBottom: '1rem' }}>
        <label style={{ fontSize: '.85rem', fontWeight: 600, color: 'var(--azul)', display: 'block', marginBottom: '.3rem' }}>Correo electrónico *</label>
      ...
      <div style={{ marginBottom: '1rem' }}>
        <label style={{ fontSize: '.85rem', fontWeight: 600, color: 'var(--azul)', display: 'block', marginBottom: '.3rem' }}>Me interesa</label>
      ...
      <div style={{ marginBottom: '1rem' }}>
        <label style={{ fontSize: '.85rem', fontWeight: 600, color: 'var(--azul)', display: 'block', marginBottom: '.3rem' }}>Mensaje</label>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px', marginBottom: '1rem' }}>
        ...
        <label style={{ fontSize: '.85rem', color: '#666', lineHeight: 1.4, cursor: 'pointer' }}>
          He leído y acepto el <strong style={{ color: 'var(--rojo)' }}>Aviso de Privacidad</strong>
        </label>
      </div>
      ...
      {estado === 'err' && (
        <p style={{ color: 'var(--rojo)', textAlign: 'center', marginTop: '1rem', fontSize: '.9rem' }}>
