      ...
      <main style={{ background: 'var(--superficie)', minHeight: '70vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem 2rem' }}>
        <div style={{ textAlign: 'center', maxWidth: '520px' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/"
              style={{ background: '#fff', color: 'var(--azul)', padding: '.85rem 1.8rem', borderRadius: '12px', fontWeight: 700, textDecoration: 'none', fontFamily: 'Montserrat, sans-serif', border: '2px solid var(--azul)', display: 'flex', alignItems: 'center', gap: '.5rem' }}>
          ...
          <div style={{ marginTop: '3rem', padding: '1.5rem', background: '#fff', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,.06)' }}>
            ...
            <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WA_NUMBER || '524778116501'}?text=${encodeURIComponent('Hola, necesito ayuda en el sitio de Vive Bien.')}`}
              ...
              style={{ display: 'inline-flex', alignItems: 'center', gap: '.5rem', background: 'var(--whatsapp)', color: '#fff', padding: '.65rem 1.3rem', borderRadius: '8px', fontWeight: 700, textDecoration: 'none', fontSize: '.9rem' }}>
